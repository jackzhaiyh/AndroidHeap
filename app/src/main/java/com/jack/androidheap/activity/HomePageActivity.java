...
import com.jack.androidheap.activity.base.BaseFragmentActivity;
import com.jack.androidheap.activity.base.StackLayout;
import com.jack.androidheap.fragment.base.BaseFragment;
import com.jack.androidheap.fragment.homepage.HomePageFragment;
...
//        registerReceiver(m2G3GChangedReceiver, new IntentFilter(f), BroadcastAction.SEND_BROADCAST_PROMISSION, null);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        JLog.d("StackLayout", "a onKeyDown");
...
//                }
                ...
                JLog.d(TAG, "zxg@@@@@ onKeyDown size() is:" + size());
                if (size() > 1) {
                    popBackStack();
                    return true;
                }
    ...
    protected void onResume() {
        super.onResume();
        JLog.d(TAG, "On Resume" + getClass().getSimpleName());
    }

    @Override
    protected void onPause() {
        super.onPause();
        JLog.d(TAG, "onPause " + getClass().getSimpleName());
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        JLog.d(TAG, "onSaveInstanceState do nothing");
    }

    @Override
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        JLog.d(TAG, "onRestoreInstanceState do nothing too");
    }
}
